<<<<<<< HEAD:Test-Categories/Test_Categories/Edit_Category.php
<?php
    ...
    <div class="container padding-bottom-3x mb-2">
        <div class="row justify-content-center">
            <div class="col-lg-8 col-md-10">
                ...
                <?php
                    $sql = $conn->prepare("SELECT * FROM `test_categories` WHERE category_id='$category_id'");
                    $sql -> execute();
...
>>>>>>> 0dca613 (commiteed change):Test-Categories/ajax/Edit_Category.php
</html>