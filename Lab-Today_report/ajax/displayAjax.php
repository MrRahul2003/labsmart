...
$i = 0;
    while ($row = mysqli_stmt_fetch($result)) {
        ...
        '<tr>
            ...
            <td>
            <p>'.htmlentities($fname,ENT_NOQUOTES,'UTF-8').' '.htmlentities($lname,ENT_NOQUOTES,'UTF-8').'</p>
            <p>'.htmlentities($mobile,ENT_NOQUOTES,'UTF-8').'</p>
            </td>
            ...
            <td><span class="badge bg-success" mb-0">'.htmlentities($report,ENT_NOQUOTES,'UTF-8').'</span></td>
            <td>
